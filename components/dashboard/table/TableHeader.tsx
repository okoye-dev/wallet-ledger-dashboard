  ...
  if (config.sortable && config.field) {
    return (
      ...
      >
        <Button
          variant="ghost"
          className={`h-auto p-0 hover:bg-transparent font-semibold ${TABLE_STYLES.textSizes.header} ${TABLE_STYLES.headerColor} group-hover:text-foreground flex items-center justify-between w-full gap-1`}
        >
